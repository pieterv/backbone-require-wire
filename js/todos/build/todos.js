...
(function (root) { define('underscore',[], function () { (function () {
 ...
 * template.js
 */
define('wire/underscore/template',['require', 'underscore'], function(require, _) {
...
// define( [ 'wire', 'specs/main' ], function( wire, main ) {

// 	wire( main ).then( function( context ) {
